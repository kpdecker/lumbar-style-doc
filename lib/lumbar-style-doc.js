...
var resourceDir = require('path').resolve(__dirname + '/../resources/'),
    handlebarsDir = require('path').resolve(__dirname + '/../node_modules/handlebars/dist');
...
module.exports = function(options) {
  ...
  return {
    ...
    moduleResources: function(context, next, complete) {
      next(function(err, moduleResources) {
        if (context.module['style-doc']) {
          // Filter all content if the removeDocs flag has been set
          ...
          if (context.mode === 'static') {
            ...
            moduleResources.unshift({src: handlebarsDir + '/handlebars.js', global: true, ignoreWarnings: true});
            moduleResources.unshift({src: resourceDir + '/zepto.js', global: true, ignoreWarnings: true});
    ...
    resource: function(context, next, complete) {
      if (context.mode === 'static' && context.resource['style-doc'] === true) {
