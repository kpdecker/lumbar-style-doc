    ...
    next(function(err, moduleResources) {
      if (context.module['style-doc']) {
        ...
        if (context.mode === 'static') {
          ...
          moduleResources.push({src: resourceDir + '/zepto.js', global: true});
          moduleResources.push({src: resourceDir + '/handlebars.js', global: true});
          moduleResources.push({src: resourceDir + '/style-doc.js', global: true});
